...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_file' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'onsen_key' => ['type' => 'index', 'columns' => ['onsen_id'], 'length' => []],
            'user_key' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'reviews_ibfk_1' => ['type' => 'foreign', 'columns' => ['onsen_id'], 'references' => ['onsens', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'score' => 1,
                'img_file' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'onsen_id' => 1,
                'user_id' => 1,
                'created' => '2018-10-29 18:25:29',
                'modified' => '2018-10-29 18:25:29'
            ],
        ];
        parent::init();
    }

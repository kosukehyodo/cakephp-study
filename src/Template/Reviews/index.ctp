    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('onsen_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($review->score) ?></td>
                <td><?= $review->has('onsen') ? $this->Html->link($review->onsen->name, ['controller' => 'Onsens', 'action' => 'view', $review->onsen->id]) : '' ?></td>
